...
public abstract class PersistenceTest {
    ...
    public static WebArchive createDeployment() {
        WebArchive webArchive = ShrinkWrap.create(WebArchive.class)
                ...
                .addPackage("com.udm.common.application")
                .addPackage("com.udm.common.application.command")
                ...
                .addPackage("com.udm.identitymanager.application")
                .addPackage("com.udm.identitymanager.application.command")
                .addPackage("com.udm.identitymanager.application.representation")
                ...
                .addPackage("com.udm.identitymanager.infrastructure.resource")
                .addPackage("com.udm.identitymanager.infrastructure.service")
                .addPackage("com.udm.identitymanager.resource")
                ...
                .addAsWebInfResource("IdentityManagementMessages.properties")
