...
import com.udm.health.validation.City;
import com.udm.health.validation.Street;
import com.udm.health.validation.ZipCode;
...
public class PersonAddress extends DomainObjectConcurrencySafe {
    ...
    /**
     * Builder of {@link com.udm.health.persistence.domain.model.PersonAddress} instances.
     *
     * @author Oscar Rico (martinezr.oscar@gmail.com)
     */
    public static class Builder implements DomainObjectBuilder<PersonAddress> {
        ...
        /**
         * Creates a instances of {@link com.udm.health.persistence.domain.model.PersonAddress}
         * given the specified characteristics on the
         * {@link com.udm.health.persistence.domain.model.PersonAddress.Builder}.
         *
         * @return a new instance {@link com.udm.health.persistence.domain.model.PersonAddress}
         */
        @Override
