...
public class Physician extends Person {
    ...
    /**
     * Builder of {@link com.udm.health.persistence.domain.model.Physician} instances.
     *
     * @author Oscar Rico (martinezr.oscar@gmail.com)
     */
    public static class Builder implements DomainObjectBuilder<Physician> {
        ...
        /**
         * Creates a instances of {@link com.udm.health.persistence.domain.model.Physician} given
         * the specified characteristics on the
         * {@link com.udm.health.persistence.domain.model.Physician.Builder}.
         *
         * @return a new instance {@link com.udm.health.persistence.domain.model.Physician}
         */
        @Override
